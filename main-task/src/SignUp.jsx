    ...
    <div className="form-container">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="form-group">
          ...
          <input type="email" id="email" placeholder="Enter the Email" {...register("email", { required: "Email is required", pattern: { value: validateEmail , message: "Invalid email address", }, validate: validateEmailForTestCase})} />
